      ...
      <div class="container mx-auto py-14 md:py-28 flex flex-col gap-6">
        <div class="pb-2">
          ...
          <p>
            ...
            warrant that the information accessible via this website is
            accurate, complete or current. In no circumstances, to the extent
            permitted by law, shall the Union or or any of its officers or
            employees be liable for any loss, additional costs or damage
            (howsoever arising) suffered as a result of any use of this website
            or its contents.
          </p>
        </div>
        <div class="pb-2">
        ...
        <div class="pb-2">
          ...
          <p>
            All the content of this website (including images), unless
            explicitly stated otherwise, is copyright of the University of York
            Students' Union and may not be reproduced without prior permission.
            By accessing these web pages, you agree that any downloading of
            content is for personal, non-commercial reference only. No part of
            this website may be reproduced or transmitted in any form or by any
            means without the prior consent of the Union. For any queries about
            re-use of content from the website, please contact
            <a
              class="text-roses-red hover:underline"
        ...
        <div>
          ...
          <p>
            ...
            by the web browser as required. The use of cookies is a convenient
            way of allowing a computer to remember specific information relating
            to a website which has been visited.
          </p>
